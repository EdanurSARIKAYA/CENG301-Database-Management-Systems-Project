...
public class ControllerView implements ViewInterface {
    ...
    Map<String, Object> getWhereParameters() throws Exception {
        ...
        Integer controllerID = getInteger("ControllerID : ", false);

        Map<String, Object> whereParameters = new HashMap<>();

        if (controllerID != null) {
            whereParameters.put("ControllerID", controllerID);
        }
    ...
    ViewData selectGUI(ModelData modelData) throws Exception {
        ...
        return new ViewData("Controller", "select", parameters);
    }
